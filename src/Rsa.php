...
class Rsa
{
    ...
    {
        $this->privateKey = openssl_pkey_get_private(file_get_contents($privateKeyFile));//私钥，用于加密
        $this->publicKey = openssl_pkey_get_public(file_get_contents($publicKeyFile));//公钥，用于解密
